...
**YOU ARE IN: `ralph/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ralph/` (rig root) or other directories
...
**Your mail address:** `ralph/polecats/obsidian`
**Your rig:** ralph
**Your Witness:** `ralph/witness`
...
| Ask Witness for help | `gt mail send ralph/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ralph/witness`) when:
...
```bash
gt mail send ralph/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
