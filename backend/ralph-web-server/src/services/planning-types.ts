/**
 * PlanningService type definitions.
 *
 * Pulled out of PlanningService.ts so the class file can focus on behavior.
 * Consumers typically import these via the PlanningService barrel re-exports,
 * but direct imports from this module are also supported.
 */
